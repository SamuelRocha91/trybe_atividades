...
let fruits = {};
for(let index = 0; index < basket.length; index = index + 1){
    if(fruits[basket[index]] === undefined){
      fruits[basket[index]] = 1;
    }
    else{
      fruits[basket[index]] = fruits[basket[index]] + 1
    }
}
console.log(fruits)
...
for(let index in fruits){
  console.log(`Sua cesta possui ${fruits[index]} ${index}, `)
}
